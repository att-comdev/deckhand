...
.. note::
    ...
    value pass ``service_type=SERVICE_TYPE`` to ``client.Client`` below.
...
Alternatively, you can instantiate a client with a Keystone session:
