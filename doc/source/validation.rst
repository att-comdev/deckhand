...
.. py:data:: deckhand.engine.schemas.base_schema.schema
...
.. py:data:: deckhand.engine.schemas.certificate_key_schema.schema
  ...
  :data:`deckhand.engine.schemas.base_schema.schema` has passed. Failure to
  pass this schema will result in an error entry being created for the
  validation with name ``deckhand-schema-validation`` corresponding to the
  created revision.

.. py:data:: deckhand.engine.schemas.certificate_schema.schema
...
.. py:data:: deckhand.engine.schemas.dataschema_schema.schema
...
.. py:data:: deckhand.engine.schemas.document_schema.schema
...
.. py:data:: deckhand.engine.schemas.layering_policy_schema.schema
...
.. py:data:: deckhand.engine.schemas.passphrase_schema.schema
...
.. py:data:: deckhand.engine.schemas.validation_policy_schema.schema
