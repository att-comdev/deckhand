...
However, replacement documents can be abstract or concrete, though replacing
a concrete document with an abstract document will likely lead to unintended
results.
