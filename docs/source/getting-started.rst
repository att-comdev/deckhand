...
To create an automatic migrations requires that the Deckhand database model is
...
One way of creating an automatic migration is to deploy a development Dekchand
