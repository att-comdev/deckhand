...
def _documents_create(values_list, session=None):
    ...
    for values in values_list:
        ...
        # FIXME(fmontei): Remove this once secret validation/substitution is
        # merged.
        if values['schema'] == types.PASSPHRASE_POLICY_SCHEMA:
...
def _filter_revision_documents(documents, **filters):
    ...
    # for this endpoint.
    viewable_documents = [d for d in documents
