...
def documents_create(values_list, session=None):
    ...
    # TODO(fmontei): A list of all the validations should be passed to this
    # function after being generated by `deckhand.engine.document_validation`.
    ...
    for values in values_list:
        ...
        values['validations'] = validations
