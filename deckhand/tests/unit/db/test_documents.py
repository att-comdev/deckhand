...
class TestDocuments(base.TestDbBase):
    ...
    def test_delete_document(self):
        ...
        result = self.delete_document(document_id=documents[0]['id'])
        self.assertTrue(result['deleted'])

        # Valdate that the document no longer exists.
        self.assertEmpty(
            self.list_revision_documents(documents[0]['revision_id']))
    ...
    def test_show_deleted_document(self):
        ...
        deleted_documents = self.list_revision_documents(
