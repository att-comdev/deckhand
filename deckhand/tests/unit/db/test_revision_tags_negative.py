...
class TestRevisionTagsNegative(base.TestDbBase):
    ...
    def test_check_tag_revision_not_found(self):
        self.assertRaises(
            errors.RevisionNotFound, db_api.revision_tag_check,
            test_utils.rand_uuid_hex())
    ...
    def test_replace_all_tags_revision_not_found(self):
        self.assertRaises(
            errors.RevisionNotFound, db_api.revision_tag_replace_all,
            test_utils.rand_uuid_hex())
