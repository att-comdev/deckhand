...
class TestBucketsControllerNegative(test_base.BaseControllerTest):
    ...
    def test_put_bucket_with_invalid_document_payload(self):
        # NOTE: We do not override the policy rule that is enforced by this
        # endpoint since document validation occurs before policy enforcement,
        # so a 400 should always be thrown before a 403.
