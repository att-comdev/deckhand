...
class RealPolicyFixture(fixtures.Fixture):
    ...
    def _install_policy_verification_hook(self):
        ...
        ``self.actual_policy_actions`` should be down in the ``tearDown``
        ...
        def enforce_policy_and_assert_called_with_expected_rules(
                action, *a, **k):
        ...
        mock_do_enforce_rbac.side_effect = (
            enforce_policy_and_assert_called_with_expected_rules)
