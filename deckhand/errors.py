...
def format_error_resp(req,
    ...
    error_response = {
        ...
        'code': status_code,
        # NOTE(fmontei): All of Deckhand's operations are currently synchronous
        # so always return `False` for retry, since retrying the failed
        # operation won't make a difference.
