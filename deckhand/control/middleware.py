...
class YAMLTranslator(HookableMiddlewareMixin, object):
    ...
    Falcon error exceptions use JSON formatting and headers by default. This
    middleware will intercept all responses and guarantee they are YAML format.
    ...
    def process_response(self, req, resp, resource):
        ...
        for attr in ('body', 'data'):
            ...
            elif isinstance(resp_attr, list):
