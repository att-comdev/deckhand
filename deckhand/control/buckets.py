...
class BucketsResource(api_base.BaseResource):
    ...
    def on_put(self, req, resp, bucket_name=None):
        ...
        cleartext_documents = []  # Represent all "regular" documents.
        secret_documents = []  # Represent documents that handle secrets.
        ...
        self._prepare_secret_documents(secret_documents)
