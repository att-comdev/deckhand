...
class RevisionTagsResource(api_base.BaseResource):
    ...
    @policy.enforce('deckhand:create_tag')
    ...
    @policy.enforce('deckhand:show_tag')
    ...
    @policy.enforce('deckhand:list_tags')
    ...
    @policy.enforce('deckhand:delete_tag')
    ...
    @policy.enforce('deckhand:delete_tags')
