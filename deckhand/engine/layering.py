# Copyright 2017 AT&T Intellect# Copyright 2017 AT&T Intellectual Property.  All other rights reserved.
#
...
class DocumentLayering(object):
    ...
    def _calc_document_children(self, document):
        try:
            ...
            return
        potential_children = self._documents_by_parent_selector.get(
            str(document.labels), [])
    ...
    def _get_layering_order(self, layering_policy):
        ...
        for layer in layer_order[:]:
            documents_by_layer = self._document_layer_map.get(layer, [])
    ...
    def __init__(self, documents, substitution_sources=None):
        ...
        self._documents_by_parent_selector = {}
        ...
        for document in documents:
            ...
            if document.parent_selector:
                self._documents_by_parent_selector.setdefault(
        ...
        del self._document_layer_map
        del self._documents_by_parent_selector
    ...
    def _apply_substitutions(self, document):
        ...
        except errors.SubstitutionDependencyNotFound as e:
            LOG.error('Failed to substitute data into document [%s] %s '
                      'because the dependent document could not be found.',
