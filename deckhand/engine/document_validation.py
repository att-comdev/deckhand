...
class SchemaValidator(BaseValidator):
        ...
        def __init__(self):
            ...
            self.registerd_schemas = self._register_all_schemas()
        ...
        def _get_schemas(self, document):
            ...
            matching_schemas = []
            for schema_prefix, schema in self.registerd_schemas.items():
...
class DocumentValidation(object):
    ...
    def __init__(self, documents):
        ...
        self._validators = [GenericValidator(), SchemaValidator()]
        self.documents = []
