...
class SecretsManager(object):
    ...
    def create(self, document_id, secret_doc):
        ...
        if encryption_type == ENCRYPTED:
            ...
            kwargs = {
                ...
                'payload_content_type': secret_type,
                # NOTE(fmontei): Required. Currently only base64 is supported
                # according to: https://docs.openstack.org/barbican/latest/api/reference/secrets.html
            ...
            created_secret = db_api.secret_create(
                document_id, secret_ref=secret_ref)
