...
class SecretsSubstitution(object):
    ...
    def substitute_all(self):
        ...
        layer-independent, so given the 3 layer example above, which includes
        global, region and site layers, a document in the region layer could
        insert data from a document in the site layer.
        ...
        for doc in self.documents:
            ...
            for sub in doc.get_substitutions():
                ...
                # TODO(fmontei): Filter by abstract=False.
